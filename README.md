# Cybersecurity Portfolio — Vaibhav Deep Singh
...
- **Education**: B.Sc. Computer Science & Ethical Hacking training.
- **Skills**: Categorized technical arsenal (SIEM, EDR, Frameworks, Tools).
- **Projects**: 5 security projects with GitHub links and expandable details.
- **Achievements**: Hackathon wins, TryHackMe stats, bug bounty findings — with certificate links.
...
├── js/main.js               # Globe, animations, data rendering
├── assets/
│   └── resume.html          # Printable resume (Print to PDF)
├── certificate/             # Certificate PDFs & images
├── tryhackme.JPG            # TryHackMe badge image
└── .gitignore
```
